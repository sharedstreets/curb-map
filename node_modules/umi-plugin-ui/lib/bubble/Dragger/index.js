...
var Container = _styledComponents.default.div(_templateObject(), function (_ref) {
  ...
  return dragged ? 'grab' : 'pointer';
}, initRight, initBottom, function (_ref2) {
  var hide = _ref2.hide;
  return hide ? 'transition: all .3s;' : '';
}, function (_ref3) {
  var hide = _ref3.hide,
      dragged = _ref3.dragged;
  return hide && !dragged ? 'right: 0!important;' : '';
}, _Hide.HideWrapper, _Tooltip.TooltipWrapper, function (_ref4) {
  var open = _ref4.open,
      hide = _ref4.hide;
