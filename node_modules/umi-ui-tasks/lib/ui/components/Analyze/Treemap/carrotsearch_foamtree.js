...
(function () {
  ...
  var ia = {
    ...
    rj: function rj(a, l, k, f) {
      ...
      for (g = 0; g < b; g++) d = l[g], c = l[(g + 1) % b], h = l[(g + 2) % b], n = m[(g + 1) % b], n = Math.min(0.5, k / n), M.Aa(1 - n, c, h, e), M.Aa(n, c, h, q), p++, 0 == g && (h = Math.min(0.5, k / m[0]), M.Aa(h, d, c, f), p++, a.moveTo(f.x, f.y)), a.quadraticCurveTo(c.x, c.y, e.x, e.y), a.lineTo(q.x, q.y);
  ...
  function pa(a) {
    var l = new V(),
        k = a.length;
    if (0 < a.length) for (var f = a.length - 1; 0 <= f; f--) a[f].N(function () {
      0 === --k && l.J();
    });else l.J();
    return l.L();
  }
  ...
  var M = new function () {
    ...
    this.k = function (a, f) {
      for (var d = 0, c = 0, g = a.length, m = a[0], e = 0, b = 1; b < g - 1; b++) var h = a[b], n = a[b + 1], l = m.y + h.y + n.y, p = (h.x - m.x) * (n.y - m.y) - (n.x - m.x) * (h.y - m.y), d = d + p * (m.x + h.x + n.x), c = c + p * l, e = e + p;
  ...
  var za = new function () {
    ...
    this.S = function (c) {
      function f(b, c, d) {
        ...
        for (e = 0; e < g; e++) h = c[e].kd, !0 !== l[h.index] && 0 > r * (h.x - k.x) + s * (h.y - k.y) + m * (h.z - k.z) && a.d(b, h);
      }
      ...
      if (0 < (p = function () {
        ...
        for (e = 4; e < n; e++) for (f = c[e], g = 0; 4 > g; g++) h = q[g], k = h.ma[0], m = h.Oa, 0 > m.x * (f.x - k.x) + m.y * (f.y - k.y) + m.z * (f.z - k.z) && a.d(h, f);
        ...
        for (; p < n;) {
          ...
          if (b.$b) {
            ...
            a: for (; m < q.length; m++) if (h = q[m], !1 === h.visible) {
              var w = h.C;

              for (e = 0; 3 > e; e++) if (!0 === w[e].visible) {
                r = h;
                s = e;
                break a;
              }
            ...
            do if (h.push(t), w.push(y), y = (y + 1) % 3, !1 === t.C[y].visible) {
            ...
            for (e = 0; e < q.length; e++) if (h = q[e], !0 === h.visible) {
              w = h.kb;
              t = w.length;
  ...
  var Ba = new function () {
    function a(a) {
      for (var f = a[0].x, d = a[0].y, c = f, g = d, m = 1; m < a.length; m++) var e = a[m], f = Math.min(f, e.x), d = Math.min(d, e.y), c = Math.max(c, e.x), g = Math.max(g, e.y);
    ...
    this.S = function (k, f) {
      ...
      function e(a, b, c, d) {
        ...
        if (0 == e.length) f = e = null;else if (-1 !== n) for (; s != n;) n = (n + 1) % k, e.push(b[n]), f.push(null);
        a.o = e;
        a.C = f;
      }
      ...
      if (1 === k.length) k[0].o = f.slice(0), k[0].C = [];else {
        ...
        for (b = 0; b < k.length; b++) if (q = n[b], 0 !== q.length) {
          var r = k[b];
          q = m(q);
          var s = q.length,
              w = -1;
    ...
    this.zc = function (k, f) {
      ...
      if (g) {
        ...
        for (d = 0; d < e; d++) if (h = b[d], 0 < h.Oa.z) {
          var n = h.ma,
              l = n.length;
  ...
  var Ca = new function () {
    ...
    this.Ja = function (a, l, k) {
      ...
      if (f[0].C) {
        ...
        for (l = l.ic = 0; g < c;) if (f = d[g++], !f.ld && f.C) {
          k(f, l++, f.ic);
          f.ld = !0;
          var m = f.C,
              e = m.length;
  ...
  function Ia(a) {
    ...
    function n(a, b, c) {
      ...
      return function (e, f) {
        if (!c || c(f)) {
          for (var g = a ? f.aa || f.o : f.o, h, k = g.length - 1; 0 <= k; k--) h = void 0 !== b ? b(f, g[k], d) : g[k], e.$c = Math.min(e.$c, h.x), e.Od = Math.max(e.Od, h.x), e.ad = Math.min(e.ad, h.y), e.Pd = Math.max(e.Pd, h.y);
    ...
    function f(a, b, c, d) {
      ...
      T.Jc([c, C], function (d) {
        ...
        if (0 !== b.length) {
          ...
          for (g = $.length - 1; 0 <= g; g--) if (h = $[g], e[h.id]) for (var k = h.be, h = 0; h < b.length; h++) {
            var l = b[h];
    ...
    function c() {
          ...
          Z.F(z, function (a) {
            if (a.$ && !a.description && (a.Z || a.I || a.Yc && a.parent.X && a.Sa)) {
              var b,
                  ...
                  d = [a],
                  e = a.C || a.parent.e;
              if (q) for (b = 0; b < e.length; b++) (c = e[b]) && d.push(c);else if (r) if (!a.selected && a.ab) {
                c = !0;
      ...
      (function () {
        ...
        a ? (Z.Kc(z, function (a) {
          ...
          if (a.$ && (a.opacity !== a.bd || a.Ma)) {
            for (var b = a.Xc, c = a; (c = c.parent) && c !== z;) b += c.opacity * c.sa.a * u.Zf;
      ...
      Z.xd(z, function (b) {
        if (b.$ && b.X && b.Ca && b.M && (z.I || b.Z || b.me)) {
          ...
          if (1 < H / a.f) {
            ...
            if (b.ea && e) for (f = c.length - 1; 0 <= f; f--) if (b = c[f], 1 !== b.scale && (b.Vb(a, d), d.f = a.f / b.scale, d.i = a.i / b.scale), !1 === b.ea && b.o) {
              var e = b.o,
                  g = e.length;
              if (M.Va(b.o, 1 === b.scale ? a : d)) b.ea = !0;else for (var h = 0; h < g; h++) if (M.Mg(e[h], e[(h + 1) % g], 1 === b.scale ? a : d)) {
                b.ea = !0;
        ...
        if (0 !== c.length) {
          ...
          for (var l = k = 0; l < h.length; l++) {
            for (var m = h[l], p = a.length - 1; 0 <= p; p--) if (b[p]) {
              ...
              for (f = k; f < m; f++) g = c[f], d.save(), g.Tb(d), n.wb.call(n, g, d, e), d.restore();
    ...
    this.yc = function (a, b) {
      D.defer(function () {
        if (T) u.mi(a), T = !1;else {
          if (b) for (var d = x.k(b), e = d.length - 1; 0 <= e; e--) d[e].I = !0;else q.I = !0;
          c(a);
        }
      });
    };
...
var _default = CarrotSearchFoamTree;
