...
exports.reactNativeTemplate = exports.reactDomTemplate = exports.toReactNative = exports.titleProp = exports.svgRef = exports.svgProps = exports.stripAttribute = exports.replaceAttrValues = exports.removeDimensions = exports.removeComments = exports.expandProps = exports.emSize = exports.default = void 0;
...
var _util2 = require("./templates/util");

Object.keys(_util2).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
  if (Object.prototype.hasOwnProperty.call(_exportNames, key)) return;
  exports[key] = _util2[key];
});
