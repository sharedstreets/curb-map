...
import findRoute, {
  getUrlQuery,
} from '/home/simon/files/miscellaneous/demos/demos/src/phila-curb-map/node_modules/umi-build-dev/lib/findRoute.js';
...
(() => {
  try {
    ...
    require('../../../node_modules/umi-plugin-ui/lib/bubble').default({
      port: 3000,
      path: '/home/simon/files/miscellaneous/demos/demos/src/phila-curb-map',
      currentProject: '',
      isBigfish: undefined,
    });
  } catch (e) {
